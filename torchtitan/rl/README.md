...
# Qwen3.5 hd256 paged attention requires the fixes in FA4 b31, and b32 sizes
# the hd256 varlen grids by the longest document instead of the packed total
# (packed training batches run up to 6x faster).
uv pip install "flash-attn-4[cu13]>=4.0.0b32"
```
