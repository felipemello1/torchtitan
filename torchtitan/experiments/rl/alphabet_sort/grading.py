...
def extract_names(completion: str, *, turn_idx: int) -> list[str]:
    ...
    # TODO: when a completion contains multiple ``<{tag}>...</{tag}>``
    # blocks (the model re-tried mid-response), enforce strict monotonic
    # improvement across attempts; reward 0 otherwise. See Opus
    # ``score_completion_text`` for the reference shape.
