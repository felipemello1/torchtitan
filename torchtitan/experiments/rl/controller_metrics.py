...
def compute_policy_age_metrics(
    *,
    ...
    batch actually trains against. Ages above `target_offpolicy_steps` are counted and warned about,
    never rejected: the buffer depth targets the mean age, and a straggler group is trained late.
    ...
    Example:
        ...
        #    train_batch/num_samples_over_target_age 1, and one logger.warning (5 > 3)
    """
    policy_ages = [
