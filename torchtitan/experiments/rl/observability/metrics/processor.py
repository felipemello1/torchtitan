    ...
    class Config(Configurable.Config):
        ...
        console_log_keys_train: list[str] | None = field(
            default_factory=lambda: [
                ...
                "train/cuda_memory/fwd_bwd/peak_allocated_gib",
                "train/cuda_memory/fwd_bwd/peak_reserved_gib",
                "train/cuda_memory/fwd_bwd/driver_used_pct",
                "train/cuda_memory/optim/peak_allocated_gib",
                "train/cuda_memory/optim/peak_reserved_gib",
                "train/cuda_memory/optim/driver_used_pct",
