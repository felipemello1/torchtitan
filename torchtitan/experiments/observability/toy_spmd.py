...
from torchtitan.observability import (
    clear_step_tags, EventType, init_observability,
...
class ToyTrainer:
    ...
    def train_step(self, tokens, labels, loss_mask, step):
        ...
        with record_span("Forward/Backward", EventType.FWD_BWD):
            ...
            # FSDP2 wraps outputs as DTensors. Convert to local for plain loss
            # computation with loss_mask. For large vocabs, use loss_parallel()
    ...
    def train(self, tokens, labels, loss_mask, num_steps):
        ...
        for step in range(1, num_steps + 1):
            ...
            # System metric: point-in-time scalars logged to system JSONL
